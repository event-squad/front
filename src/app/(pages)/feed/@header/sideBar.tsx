  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="w-11/12 m-2 py-2 cursor-pointer flex justify-around items-center text-white font-extrabold rounded-sm border-solid border-white border-2 absolute bottom-0 left-0 hover:bg-[#613D37]"
      >
        <h1>Fazer logout</h1>
