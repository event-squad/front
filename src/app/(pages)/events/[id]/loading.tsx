  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="relative cursor-pointer flex justify-center items-center">
        <div className="rounded-full animate-pulse bg-white opacity-20 w-10 h-10"></div>
      </div>
      <h1 className="text-white text-lg font-extrabold w-24"></h1>
      <div>
        <div className="relative cursor-pointer flex justify-center items-center">
          <div className="rounded-full animate-pulse bg-white opacity-20 w-10 h-10"></div>
        </div>
      ...
      <div className="z-20 flex justify-around items-center absolute bottom-0 bg-gradient-to-b from-transparent via-rgba(30, 12, 7, 0.8) to-black w-full h-32">
        ...
        <div>
          <div className="w-56 h-20 p-2 rounded-full main-bg animate-pulse relative cursor-pointer flex justify-center items-center"></div>
        </div>
      </div>
      <div>
