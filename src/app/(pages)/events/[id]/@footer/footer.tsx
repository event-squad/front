  ...
  return (
    <div className="flex justify-around items-center absolute bottom-0 bg-gradient-to-b from-transparent via-rgba(30, 12, 7, 0.8) to-black w-full h-32">
      <button
        ...
        className="flex justify-center items-center pt-1 rounded-full w-20 h-20 bg-[#FFFFFF33] text-red"
      >
        {active ? (
          <IconHeartFilled className="text-5xl text-white" />
        ) : (
          <IconHeart className="text-5xl text-white" />
        )}
      </button>
