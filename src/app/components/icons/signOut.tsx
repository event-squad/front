// icon:sign-out-16 | Octicons https://primer.style/octicons/ | Github Primer
import * as React from "react";

function IconSignOut16(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 16 16"
      fill="currentColor"
